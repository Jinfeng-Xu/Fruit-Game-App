...
public class PearActivity extends AppCompatActivity {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.btn_cn:
                    ...
                    break;
                case R.id.btn_back:
                    Intent intent = new Intent(PearActivity.this, MainActivity.class);
    ...
    public void flag(){
        if(flag){
            ...
            mtvInfo.setText(getResources().getString(R.string.pear_en));
            mtvTitle.setText("Pear");
        }
        else{
            mtvInfo.setText(getResources().getString(R.string.pear_cn));
            mtvTitle.setText("梨");
            btnBack.setText("返回");
            btnCN.setText("中文");
            btnEN.setText("英文");
