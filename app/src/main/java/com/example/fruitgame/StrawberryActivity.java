...
public class StrawberryActivity extends AppCompatActivity {
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.btn_cn:
                    ...
                    break;
                case R.id.btn_back:
                    Intent intent = new Intent(StrawberryActivity.this, MainActivity.class);
    ...
    public void flag(){
        if(flag){
            ...
            mtvInfo.setText(getResources().getString(R.string.strawberry_en));
            mtvTitle.setText("Strawberry");
        }
        else{
            mtvInfo.setText(getResources().getString(R.string.strawberry_cn));
            mtvTitle.setText("草莓");
            btnBack.setText("返回");
            btnCN.setText("中文");
            btnEN.setText("英文");
